...
;; Nael buffer-locally sets `compile-command' to "lean build".
...
- Nael does not depend on third-party lsp-mode.  Instead, you can use
  Nael together with Emacs' built-in LSP-client Eglot.
